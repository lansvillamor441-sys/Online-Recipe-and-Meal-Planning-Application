...
<?php $component->withAttributes([]); ?>
    ...
    <div class="py-6">
        <a href="<?php echo e(route('mealplans.create')); ?>" class="bg-blue-500 text-white px-4 py-2 rounded">
...
<?php endif; ?>
<?php /**PATH C:\jobelle\recipe_meal_planner\resources\views/mealplans/index.blade.php ENDPATH**/ ?>