...
<?php $component->withAttributes([]); ?>
    ...
    <div class="py-6">
        <form action="<?php echo e(route('mealplans.update', $mealplan)); ?>" method="POST">
            <?php echo csrf_field(); ?>
            <?php echo method_field('PUT'); ?>

            <div class="mb-4">
                <label>Week Name</label>
                <input type="text" name="week_name" value="<?php echo e($mealplan->week_name); ?>" class="w-full border p-2 rounded" required>
            </div>
                ...
                <?php $__currentLoopData = $recipes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $recipe): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="border p-2 rounded">
                        ...
                        <?php $__currentLoopData = $mealplan->items; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <?php echo e($item->recipe_id == $recipe->id ? 'checked' : ''); ?>
            ...
            <button class="bg-green-600 text-black px-4 py-2 mt-4 rounded">Update Meal Plan</button>
        </form>
    </div>
...
<?php endif; ?>
<?php /**PATH C:\Online Recipe and Meal Planning Application\recipe_meal_planner\resources\views/mealplans/edit.blade.php ENDPATH**/ ?>